<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AllOrders.aspx.cs" Inherits="FoodyMan.AllOrders" %>
    ...
    <div id="orderDetailsModal" class="modal-backdrop" runat="server">
        <div class="modal-content">
            ...
            <asp:GridView ID="gvOrderItems" runat="server" CssClass="order-items-table" AutoGenerateColumns="False">
                <Columns>
                    <asp:BoundField DataField="FoodItemID" HeaderText="Food Item" />
